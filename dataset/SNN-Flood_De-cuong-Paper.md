...
- **✅ Đã chốt với thầy (03/07/2026) — 2 setup, phân vai rõ ràng:**
  - **Setup B (hand-labeled split) — KẾT QUẢ CHÍNH:** Chỉ dùng ảnh `S1Hand` + nhãn `LabelHand` (446 chip), tự chia train/val/test theo tỷ lệ **60/20/20** (≈ 268/89/89 chip), **phân tầng theo vùng địa lý** (11 vùng) và **cố định seed** để tái lập. Train + val + test đều trên nhãn thủ công → đây là bảng kết quả trung tâm của paper.
